...
Rscript standardize_phen.R /u/home/m/mikechen/project-sriram/PRS-sim/data/$pop/pheno-test/

# split into training and validation
awk '{print $2}' ${out}.fam | sort -R > ../data/$pop/pheno-test/indi-rand.txt
bash ./train-val-test.sh $pop
